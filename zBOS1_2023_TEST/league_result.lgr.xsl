...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  -->
  <xsl:variable name="comp_result" select="/Fs/FsCompetition[1]/FsCompetitionResults/FsCompetitionResult[@top=$top_x_tasks and @id=$result_id]"/>
    ...
    <table class="fs_res">
      <thead>
        <tr class="fs_res_res_row" onmouseover="this.className = 'hover'" onmouseout="this.className='fs_res_res_row'" >
          ...
          <th class="fs_res">Day Quality</th>
          <th class="fs_res"></th>
        </tr>
      </thead>
      <tbody>
    ...
    <tr class="fs_res_res_row" onmouseover="this.className = 'hover'" onmouseout="this.className='fs_res_res_row'" >
      ...
      <xsl:for-each select="FsTask">
        ...
        <xsl:choose>
          ...
          <xsl:otherwise>
            <td class="fs_res" style="text-align: right; text-decoration: line-through;color: red">
              <xsl:if test="@points > 0">
                <xsl:value-of select="@points"/>
                <br/>
                (<xsl:value-of select="/Fs/FsCompetition/FsTasks/FsTask[@id=$task_id]/FsParticipants/FsParticipant[@id=$pilot_id]/FsResult/@points"/>)
