...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:param name="category" select="0"></xsl:param>
        ...
        <xsl:for-each select="$task_participants_results">
          ...
          <xsl:if test="$penalty != 0 or $penalty_points != 0">
            <tr>
              ...
              <td class="fs_res">
                <xsl:value-of select="$task/FsParticipants[1]/FsParticipant[@id=$pilot_id]/FsResult/@penalty_reason"/>
              </td>
            </tr>
          </xsl:if>
  ...
  <xsl:template match="/">
    ...
    <html>
      ...
      <body>
        <div>
          <div class="fs_res">
            <img width="250" src="http://mycloudbase.com/GBAR2/GBAR2a (1).png"/>
            <h2><img width="250" src="http://mycloudbase.com/GBAR2/GreenD.png"/><img width="500" src="http://mycloudbase.com/GBAR2/moyes.png"/></h2><h2><img width="150" src="http://mycloudbase.com/GBAR2/flypureair.jpg"/><img width="500" src="http://mycloudbase.com/GBAR2/Avian.png"/></h2>
		<h2><img width="100" src="http://mycloudbase.com/GBAR2/rg.png"/><img width="150" src="http://mycloudbase.com/GBAR2/Beans.jpg"/><img width="250" src="http://mycloudbase.com/GBAR2/Corby.png"/></h2>
		<h2><xsl:value-of select="/Fs/FsCompetition[1]/@name"/>
            </h2>
